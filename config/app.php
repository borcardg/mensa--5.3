...
return [
    ...
    */
    ...
    // For guzzlehttp, if set to true it enables SSL certificate verification and use the default CA bundle provided by operating system
    'verify_ca'			=> env('VERIFY_CA'),
    // For guzzlehttp, if set to true

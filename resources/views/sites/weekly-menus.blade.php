            ...
            <div class="card">
                ...
                <div class="content">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group" style="width:100%">
                                ...
                                <select id="sites" class="form-control bigger-control" style="width:100%">
                                    @foreach($sites as $siteselect)
                                        @if( $siteselect->id == $site->id)
                                            <option value="{{ $siteselect->id }}" selected>{{ $siteselect->translate()->name }} </option>
                                        @else
                                            <option value="{{ $siteselect->id }}">{{ $siteselect->translate()->name }} </option>
                                        @endif
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-md-6"> 
                            <label>&nbsp; </label>
                            <a target="_blank" href="{{ url('/') }}/generate-pdf/1" id="download-word" class="btn btn-block btn-primary"> Télécharger le menu</a>
                        </div>
                        <!-- <div class="col-md-1"> 
                           
                        <label>&nbsp; </label>                            
                        
                            <a class="btn btn-link btn-md btn-block modalButton btn-primary"  data-toggle="modal" data-item-type="sites" data-id="{{ $site->id }}" data-action-type="edit" role="button">
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th>{{ trans('messages.saturday') }}</th>
                            <th>{{ trans('messages.sunday') }}</th>
                        </tr>
                    </thead>
...
<script type="text/javascript">
    ...
    function updatevView(){
        ...
        $("#download-word").attr("href", "{{ url('/') }}/generate-pdf/"+site_id+"/"+selected_date);
...
function setModalListener(){
    ...
    $('.modalButton').on('click', function(){
        ...
        var url = "{{ url('/') }}/"+this_type+"/form/"+this_action+"/"+this_id+"?noon="+this_noon;

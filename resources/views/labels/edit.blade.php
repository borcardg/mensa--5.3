<div class="modal-header">
    ...
    <h4 class="modal-title">{{ trans('messages.edit') }} <small>{{ $label->name }}</h4>
</div>
<div class="modal-body ">
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            {{ Html::ul($errors->all()) }}
            {!! Form::model($label, ['method' => 'PUT', 'action' => ['LabelController@update', $label->id], 'autocomplete' => 'off']) !!}

            <div class="row">
                <div class="col-sm-12 col-md-6">
                    {!! Form::label('fr[name]', trans('messages.namemenu')) !!}

                    {!! Form::text('fr[name]', $label->name, ['class' => 'form-control']) !!}
            ...
            <div class="row">
                <div class="col-sm-4 col-md-4">
                    ...
                    {!! Form::text('price', $label->price, ['class' => 'form-control']) !!}
                </div>
                <div class="col-sm-4 col-md-4">
                    {!! Form::label('order', trans('messages.order')) !!}
                        {!! Form::selectRange('order', 0, 10, $label->order, ['class' => 'form-control']) !!}
                </div>
                <div class="col-sm-4 col-md-4">

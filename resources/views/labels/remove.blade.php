...
<div class="modal-body ">
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <p>Êtes-vous sûr de vouloir supprimer le label <strong>{{ $label->name }}</strong> ?</p>
            <!-- if there are creation errors, they will show here -->
            {{ Html::ul($errors->all()) }}
                {!! Form::model($label, ['method' => 'DELETE', 'action' => ['LabelController@destroy', $label->id], 'autocomplete' => 'off']) !!}

...
<div class="modal-body ">
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <p>Êtes-vous sûr de vouloir supprimer l'information "<strong>{{ $notice->title }}</strong>" ?</p>
            <!-- if there are creation errors, they will show here -->
            {{ Html::ul($errors->all()) }}
                {!! Form::model($notice, ['method' => 'DELETE', 'action' => ['NoticeController@destroy', $notice->id], 'autocomplete' => 'off']) !!}

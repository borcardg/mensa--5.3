                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group" style="width:100%">
                                ...
                                <select id="sites" class="form-control bigger-control" style="width:100%">
                                    <?php $__currentLoopData = $sites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $siteselect): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>

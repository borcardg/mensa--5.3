    ...
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="content">
                    <ul class="list-unstyled team-members">
                        <?php $__currentLoopData = $labelsNoon; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <li>
                            <div class="row">
                                <div class="col-xs-8">
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="content">
                    <ul class="list-unstyled team-members">
                        <?php $__currentLoopData = $labelsEvening; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <li>
                            <div class="row">
                            <div class="col-xs-8">
                                    <?php echo e($value->translate()->name); ?> 

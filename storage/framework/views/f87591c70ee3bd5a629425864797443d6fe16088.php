			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<ul class="nav navbar-nav navbar-right">
					<?php if(Auth::guest()): ?>
						...
						<?php /* 
						     Check if the IP of the user is in the range 134.21.*.* => connected from the unifr 
						     in case print the button "register"
						     otherwise nothing
						*/ ?>
						<!-- <?php if( ip2long( Request::ip() ) >= 2249523200 && ip2long( Request::ip() ) <= 2249588735 ): ?> -->
						    <li><a href="<?php echo e(url('/auth/register')); ?>">Register</a></li>
					    <!-- <?php endif; ?> -->
